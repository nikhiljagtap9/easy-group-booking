...
@section('title', 'EasyGroup | Edit Hotel')
                  ...
                  <div class="accordion" id="collapsibleSection">
                     <div class="card accordion-item active">
                        <h2 class="accordion-header" id="headingDeliveryAddress">
                           <button type="button" class="accordion-button"> Edit Hotel </button>
                        </h2>
                           ...
                           <div class="accordion-body">
                              <div class="row g-6">
                                 <div class="col-md-3">
                                    ...
                                    <input type="text" value="{{ $hotel->hotel_name }}" name="hotel_name" id="collapsible-pincode" class="form-control" placeholder="Enter Name" />
                                 </div> 
                              </div>
                           </div>
                           <div class="clear"></div>
