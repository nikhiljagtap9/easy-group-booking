                              ...
                              <div class="accordion-body">
                                 <div class="row g-6">
                                    ...
                                    <div class="col-md-3">
                                       ...
                                       <x-text-input type="text" name="name" id="collapsible-pincode" class="form-control" placeholder="Enter Name" />
                                       <x-custom-input-error field="name" />
                                    </div>
                                    <div class="col-md-3">
                                       <label class="form-label" for="collapsible-pincode">Surname </label>
                                       <input type="text" name="surname"  id="collapsible-pincode" class="form-control" placeholder="Enter Surname" />
                                       <x-custom-input-error field="surname" />
                                    </div>
                                    <div class="col-md-3">
                                       <label class="form-label" for="collapsible-pincode">Whatsapp Number </label>
                                       <input type="text" name="whatsapp_no" id="collapsible-pincode" class="form-control" placeholder="Enter Whatsapp Number" />
                                       <x-custom-input-error field="whatsapp_no" />
                                    </div>
                                    <div class="clear"></div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                       ...
                                       <input type="text" name="email" id="collapsible-pincode" class="form-control" placeholder="Enter Email ID" />
                                       <x-custom-input-error field="email" />
                                    </div>
                                    <div class="col-md-3">
                                       <label class="form-label" for="collapsible-pincode">Password</label>
                                       <input type="text" name="password" id="collapsible-pincode" class="form-control" placeholder="Enter Password" />
                                       <x-custom-input-error field="password" />
                                    </div>
                                    <div class="col-md-3">
                                       ...
                                       <x-custom-input-error field="usertype" />
                                    </div>     
                                 </div>
                              </div>                          
                           <div class="clear"></div>
