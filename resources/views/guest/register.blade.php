         ...
         <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 align-items-center authentication-bg p-sm-12 p-6">
               <div class="w-px-400 mx-auto mt-12 pt-5">
                  ...
                  <form method="POST" class="mb-6" action="{{ route('guest.register.submit') }}">
                  @csrf
                    <div class="mb-6 midl_lrg">
                        <label for="username" class="form-label">User Name</label>
                        <input type="text" class="form-control" name="name" :value="old('name')" required placeholder="Enter User Name" autofocus autocomplete="name">
                        <x-input-error :messages="$errors->get('name')" class="mt-2" />
                    </div>
                    <div class="mb-6 midl_lrg">
                        <label for="username" class="form-label">Email ID</label>
                        <input type="text" class="form-control" name="email" :value="old('email')" required placeholder="Enter Email ID" autofocus autocomplete="email">
                    ...
                    <input type="hidden" class="form-control" name="usertype" value="guest">                
                     <div class="clear"></div>
                   ...
                   <!-- Register Button -->
                    <div class="text-center">
                        ...
                        <a href="{{ route('guest.login') }}" class="btn btn-outline-primary w-100">Login</a>
                    </div>
               </div>
            </div>
            <!-- /Register -->
